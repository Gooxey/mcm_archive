//! This module provides the [`Status enum`](Status), which gets used for the representation of the status of structs implementing the [`ConcurrentClass trait`](super::ConcurrentClass).


/// This enum represents the status of structs implementing the [`ConcurrentClass trait`](super::ConcurrentClass).
/// 
/// # Variant
/// 
/// | Variant                            | Description                                                                                                                   |
